...
delete, re-index). No chat/QA UI yet — that lands with the retrieval
milestone.
...
st.caption("Milestone 1 — document ingestion pipeline.")
        ...
        with st.expander("Preview chunks"):
            try:
                ...
                for chunk in chunks[:20]:
                    st.caption(f"Page {chunk['page_number']} · chunk {chunk['chunk_index']} · `{chunk['chunk_id']}`")
